let bddReq,bddReqU;_4aa‍.x([["default",()=>_4aa‍.o]]);_4aa‍.w("../database/messDb",[["default",["bddReq"],function(v){bddReq=v}]]);_4aa‍.w("../database/userDb",[["default",["bddReqU"],function(v){bddReqU=v}]]);
...
const getMess = async(req, res) => {
    ...
    _4aa‍.g.console.log(search);
    const {id} = req.params;

    if(search){

        let result = await bddReq.getMessSearch(search);
        _4aa‍.g.console.log(result);
